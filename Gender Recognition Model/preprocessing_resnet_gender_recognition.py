...
def training_and_testing_model(df):
    ...
    with open('./reports/preprocessing_models/gender/resnet_gender_recognition_report.txt','w') as f:
...
def print_metrics(message,metric,first_message=False):
    ...
    with open('./reports/fairness_reports/preprocessing/gender/resnet_gender_report.txt',open_type) as f:
