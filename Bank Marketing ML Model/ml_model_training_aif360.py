...
def load_dataset():
    ...
    for train_index, test_index in kf.split(df_array):
        ...
        sample_weights_test = sample_weights.iloc[test_index]
...
def test_fairness(dataset):
    ...
    sensitive_features = [
        'education_primary','education_secondary','education_tertiary','marital_divorced','marital_married','marital_single'
    ]
    ...
    print(f'DI: {marital_metric_original.disparate_impact()}')
    print(f'mean_diff: {marital_metric_original.mean_difference()}')
    ...
    print(f'DI after: {marital_metric_trans.disparate_impact()}')
    print(f'mean_diff after: {marital_metric_trans.mean_difference()}')
    ...
    print(f'DI: {ed_metric_original.disparate_impact()}')
    print(f'mean_diff: {ed_metric_original.mean_difference()}')
    ...
    print(f'DI after: {ed_metric_trans.disparate_impact()}')
    print(f'mean_diff after: {ed_metric_trans.mean_difference()}')
