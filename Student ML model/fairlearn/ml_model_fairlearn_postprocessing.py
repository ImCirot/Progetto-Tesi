...
def training_model(dataset):
    ...
    for name,prediction in predictions.items():
        ...
        DI_score = demographic_parity_ratio(y_true=y_test,y_pred=prediction,sensitive_features=g_test)
        sex_eqodds = equalized_odds_difference(y_true=y_test,y_pred=prediction,sensitive_features=g_test)
