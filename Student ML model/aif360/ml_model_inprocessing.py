...
def validate(ml_model,model_type,X_test,y_test,first=False):
    ...
    with open(f'./reports/inprocessing_models/student_metrics_report.txt',open_type) as f:
...
def print_metrics(metric, message, first_message=False):
    ...
    with open(f"./reports/fairness_reports/inprocessing/student_report.txt",open_type) as f:
