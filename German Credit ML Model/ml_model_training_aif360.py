...
def traning_and_testing_model():
    ...
    pickle.dump(post_svm_model_pipeline,open('./output_models/postop_models/svm_aif360_credit_model.sav','wb'))
    pickle.dump(post_xgb_model_pipeline,open('./output_models/postop_models/xgb_aif360_credit_model.sav','wb'))
