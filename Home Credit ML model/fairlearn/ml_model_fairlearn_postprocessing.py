...
def training_model(dataset,index):
    ...
    pickle.dump(lr_threshold,open('./output_models/postprocessing_models/fairlearn/threshold_lr_home_credit_model.sav','wb'))
    pickle.dump(rf_threshold,open('./output_models/postprocessing_models/fairlearn/threshold_rf_home_credit_model.sav','wb'))
    pickle.dump(svm_threshold,open('./output_models/postprocessing_models/fairlearn/threshold_svm_home_credit_model.sav','wb'))
    pickle.dump(xgb_threshold,open('./output_models/postprocessing_models/fairlearn/threshold_xgb_home_credit_model.sav','wb'))
