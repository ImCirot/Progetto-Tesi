...
def training_testing_models(df):
    ...
    pickle.dump(lr_model_pipeline,open('./output_models/std_models/lr_home_credit_model.sav','wb'))
    pickle.dump(rf_model_pipeline,open('./output_models/std_models/rf_home_credit_model.sav','wb'))
    pickle.dump(svm_model_pipeline,open('./output_models/std_models/svm_home_credit_model.sav','wb'))
    pickle.dump(xgb_model_pipeline,open('./output_models/std_models/xgb_home_credit_model.sav','wb'))
...
def validate(ml_model,model_type,X_test,y_test,first=False):
    ...
    with  open(f"./reports/std_models/home_credit_metrics_report.txt",open_type) as f:
...
def print_time(time,index):
    ...
    with open('./reports/time_reports/std/home_credit_report.txt',open_type) as f:
